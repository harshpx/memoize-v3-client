...
const EventEdit = () => {
	...
	return (
		<div
			ref={pageRef}
			className={cn(
				"p-4 flex flex-col gap-2 rounded-xl shadow-xl h-full w-full sm:h-auto sm:w-auto",
				"bg-white dark:bg-black border border-neutral-200 dark:border-neutral-800/80",
			)}>
